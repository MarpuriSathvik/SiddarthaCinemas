      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden" >
        ...
        <div className="relative z-10 text-center max-w-5xl px-6 mt-16" >
          <h1 className="text-6xl md:text-8xl font-heading font-bold mb-8 leading-tight animate-fade-in-up delay-100 drop-shadow-2xl">
            Welcome to <span className="text-primary italic">Siddartha</span> <br />
            <span className="font-sans font-light tracking-wide text-white/90 text-4xl md:text-6xl block mt-4">Your Movie Place</span>
          </h1>
